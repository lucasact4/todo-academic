...
public interface TarefaRepository {
    ...
    List<Tarefa> listarPorUsuario(String loginUsuario) throws RepositoryException;
    List<Tarefa> buscarPorResponsavel(String responsavel) throws RepositoryException;
    
    // Método necessário para o Modo Demo (Limpar banco)
    void limparTudo() throws RepositoryException;
}